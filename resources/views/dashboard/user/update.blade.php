                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="row mb-6" style="margin: 3px">
                                        ...
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                {{ in_array('list_events', $permissions) ? 'checked' : '' }}
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="row mb-6" style="margin: 3px">
                                        ...
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                {{ in_array('list_folders', $permissions) ? 'checked' : '' }}
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="row mb-6" style="margin: 3px">
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                {{ in_array('create_event_type', $permissions) ? 'checked' : '' }}
                                        ...
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                {{ in_array('update_event_type', $permissions) ? 'checked' : '' }}
                                        ...
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                {{ in_array('delete_event_type', $permissions) ? 'checked' : '' }}
                                        ...
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                {{ in_array('list_event_types', $permissions) ? 'checked' : '' }}
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="row mb-6" style="margin: 3px">
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                {{ in_array('create_event_user', $permissions) ? 'checked' : '' }}
                                        ...
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                {{ in_array('update_event_user', $permissions) ? 'checked' : '' }}
                                        ...
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                {{ in_array('delete_event_user', $permissions) ? 'checked' : '' }}
                                        ...
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                {{ in_array('list_event_users', $permissions) ? 'checked' : '' }}
