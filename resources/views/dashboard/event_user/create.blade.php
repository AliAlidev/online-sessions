        ...
        <div class="row">
            <div class="col-xl">
                <form id="createUserForm">
                    <h5 class="mb-0">{{ Breadcrumbs::render('create-event-user') }}</h5>
                    <div class="card mb-6">
                        <div class="card-header">
                            <h5 class="mb-0">User Information</h5>
                        </div>
                        <div class="card-body">
                            <input type="hidden" name="user_type" value="event-user">
                            <div class="row mb-3">
                                <div class="col mb-6">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="exampleFormControlSelect1" class="form-label">Events</label>
                                    <select class="form-select" id="exampleFormControlSelect1" name="event_id"
                                    ...
                                    <small class="text-body float-start error-message-div event_id-error"
                                        style="color: #ff0000 !important" hidden></small>
                                </div>
                            </div>
                        </div>
