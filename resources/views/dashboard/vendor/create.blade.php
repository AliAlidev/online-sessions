        ...
        <div class="row">
            <div class="col-xl">
                <form id="createVendorForm">
                    <h5 class="mb-0">{{ Breadcrumbs::render('create-vendor') }}</h5>
                    <div class="card mb-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-6">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="vendor-role" class="form-control" name="vendor_role"
                    ...
                    <button type="submit" class="btn btn-primary" style="float: right" id="storeButton">Crete Vendor
