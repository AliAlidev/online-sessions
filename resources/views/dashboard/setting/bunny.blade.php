                ...
                <form id="saveSettingForm">
                    <div class="card mb-6">
                        ...
                        <div class="card-body">
                            <div class="row mb-6">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" id="storage-access-token" class="form-control" name="image[storage_access_token]"
                                        placeholder="Enter Api Key" value="{{ isset($imageSetting['storage_access_token']) ? $imageSetting['storage_access_token'] : '' }}">
                            ...
                            <div class="row mb-6">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" id="storage-zone-name" class="form-control" name="image[storage_zone_name]"
                                        placeholder="Enter Api Key" value="{{ isset($imageSetting['storage_zone_name']) ? $imageSetting['storage_zone_name'] : '' }}">
                            ...
                            <div class="row mb-6">
                                <div class="col-md-8">
                                    <label for="storage-region" class="form-label">Storage Region</label>
                                    <input type="text" id="storage-region" class="form-control" name="image[storage_region]"
                                        placeholder="Enter Api Key" value="{{ isset($imageSetting['storage_region']) ? $imageSetting['storage_region'] : '' }}">
                                    <small class="text-body float-start error-message-div storage_region-error"
                                        style="color: #ff0000 !important" hidden></small>
                                </div>
                            </div>
                            <div class="row mb-6">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" id="image-pull-zone" class="form-control" name="image[image_pull_zone]"
                                        placeholder="Enter Api Key" value="{{ isset($imageSetting['image_pull_zone']) ? $imageSetting['image_pull_zone'] : '' }}">
                            ...
                            <div class="row mb-6">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" id="video-api-key" class="form-control" name="video[video_api_key]"
                                        placeholder="Enter Planner Name" value="{{ isset($videoSetting['video_api_key']) ? $videoSetting['video_api_key'] : '' }}">
                            ...
                            <div class="row mb-6">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" id="video-library-id" class="form-control" name="video[video_library_id]"
                                        placeholder="Enter Planner Name" value="{{ isset($videoSetting['video_library_id']) ? $videoSetting['video_library_id'] : '' }}">
                            ...
                            <div class="row mb-6">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" id="stream-pull-zone" class="form-control" name="video[stream_pull_zone]"
                                        placeholder="Enter Planner Name" value="{{ isset($videoSetting['stream_pull_zone']) ? $videoSetting['stream_pull_zone'] : '' }}">
