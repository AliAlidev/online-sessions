            ...
            <div class="row card-header flex-column flex-md-row pb-0">
                <div class="d-md-flex justify-content-between align-items-center dt-layout-end col-md-auto ms-auto mt-0"
                    ...
                    <div class="dt-buttons btn-group flex-wrap mb-0" style="gap: 10px">
                        ...
                        @endcan
                        @can('update_event')
                            <a target="_blank" href="{{ route('events.edit', $event->id) }}" title="Update Event"
                                class="btn btn-icon btn-primary"><i class="bx bx-edit"></i></a>
                            @endif
                        </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.refresh-folders-table', function() {
                    $('#folders-datatable tbody').html('<tr><td colspan="10">Refreshing...</td></tr>');
                    table.ajax.reload();
                })
